/*
    1) Crie uma estrutura Hora representando uma hora. 
    2) Essa estrutura deve conter os campos hora,minuto e segundo. 
    3) Agora, escreva um programa que leia um vetor de cinco posições dessa estrutura e imprima a maior hora.
*/
